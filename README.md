...
* Cards expand inline—click one to open a spotlight pane right under the tile with cover art, IGDB screenshots, trailer and a “Back to grid” toggle. Switch between the dense list view or masonry grid via the layout pills above the search bar.
